...
import { useExternalShare } from './settings/useExternalShare';
                                ...
                                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-1">
                                    {tabs.map((tab) => (
                                        <button
                                            ...
                                            className={`min-h-[56px] rounded-xl border px-3 py-3 text-left transition-all ${activeTab === tab.key
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 space-y-3">
                                                        ...
                                                        {transcriptionEngineTestResult && (
                                                            <div className={`rounded-lg border p-3 text-sm ${transcriptionEngineTestResult.status === 'ok'
                                                        ...
                                                        <>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="space-y-2">
                                                                    ...
                                                                    <div className={`text-xs ${isSelectedOllamaModelDownloaded
                                                                            ? 'text-green-700'
                                                                    ...
                                                                    <div className="inline-flex w-full rounded-lg border border-slate-200 bg-slate-50 p-1">
                                                                        {[
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                className={`flex-1 rounded-md px-2 py-1.5 text-xs font-medium transition ${ollamaPreference === option.key
                                                                ...
                                                                {ollamaPullStatus && (
                                                                    <div className={`mt-2 p-2 rounded text-xs border ${ollamaPullStatus.status === 'success'
                                                ...
                                                <div className="space-y-4 mb-6">
                                                    <div>
                                                        ...
                                                        {youtubeDataApiTestResult && (
                                                            <div className={`mt-3 p-2 rounded text-xs border ${youtubeDataApiTestResult.status === 'ok'
                                                                    ? 'bg-green-50 border-green-200 text-green-800'
                                                                    : 'bg-red-50 border-red-200 text-red-800'
                                                                }`}>
                                                ...
                                                <div className="space-y-4">
                                                    <div className="rounded-lg border border-red-100 bg-red-50/40 p-4">
                                                        ...
                                                        {youtubeOauthTestResult && (
                                                            <div className={`mt-3 p-2 rounded text-xs border ${youtubeOauthTestResult.status === 'ok'
                                                                    ? 'bg-green-50 border-green-200 text-green-800'
                                                                    : 'bg-red-50 border-red-200 text-red-800'
                                                                }`}>
