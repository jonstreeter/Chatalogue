...
from .schemas import (
    ...
    AssignSpeakerRequest, SegmentTextUpdateRequest, TranscriptRepairResultRead, AvatarCreateRequest, AvatarUpdateRequest, AvatarRead, AvatarSectionSummaryRead, AvatarWorkbenchSpeakerRead, AvatarWorkbenchRead,
...
from .db.database import create_db_and_tables, engine, IS_POSTGRES, Channel, Video, Speaker, SpeakerEmbedding, Avatar, AvatarPersonalityProfile, AvatarAppearanceProfile, AvatarVoiceProfile, TranscriptSegment, TranscriptSegmentRead, TranscriptSegmentRevision, TranscriptSegmentRevisionRead, Job, Clip, FunnyMoment, FunnyMomentRead, VideoDescriptionRevision, VideoDescriptionRevisionRead
